...
require "matakuliah-fungsi.php";
// ambil data dari tabel matakuliah
$matakuliah = mysqli_query($conn, "SELECT * FROM matakuliah INNER JOIN Dosen ON MataKuliah.id_dosen = Dosen.id_dosen");
...
<body>
  ...
  <div class="main-container">
    ...
    <main class="content vh-100 bg-body-tertiary p-5 mt-5">
      <h1 class="fs-6">Halaman Daftar matakuliah</h1>
                ...
                <div class="modal-body">
                  <form action="" method="post">
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="kode_matakuliah" name="kode_matakuliah" autocomplete="off">
                    </div>
                    <div class="mb-3">
                      <label for="nama_matakuliah" class="form-label">Nama matakuliah</label>
                      <input type="text" class="form-control" id="nama_matakuliah" name="nama_matakuliah" autocomplete="off">
                    </div>
                    <div class="mb-3">
                      <label for="sks_matakuliah" class="form-label">sks matakuliah</label>
                      <input type="number" class="form-control" id="sks_matakuliah" name="sks_matakuliah" autocomplete="off">
                    </div>
                    <div class="mb-3">
                      <label for="id_dosen" class="form-label">Dosen Pengampu</label>
                      <select name="id_dosen" class=" form-select" aria-label="Default select example">
            ...
            <tbody>
              ...
              <?php foreach ($matakuliah as $row) : ?>
                <tr class="text-center">
                  ...
                  <td class="py-3">
                    <!-- Button Edit modal -->
                    <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#edit<?= $row["id_matakuliah"] ?>">
                      Ubah
                    </button>

                    <!-- Edit Modal -->
                    <div class="modal fade" id="edit<?= $row["id_matakuliah"] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                          ...
                          <div class="modal-body text-start">
                            <form method="post">
                              <input type="hidden" class="form-control" id="id_matakuliah" name="id_matakuliah" value="<?= $row["id_matakuliah"] ?>" autocomplete="off">
                              <div class="mb-3">
                                <label for="kode_matakuliah" class="form-label">Kode Matakuliah</label>
                                <input type="text" class="form-control" id="kode_matakuliah" name="kode_matakuliah" value="<?= $row["kode_matakuliah"] ?>" autocomplete="off">
                              </div>
                              <div class="mb-3">
                                <label for="nama_matakuliah" class="form-label">Nama matakuliah</label>
                                <input type="text" class="form-control" id="nama_matakuliah" name="nama_matakuliah" value="<?= $row["nama_matakuliah"] ?>" autocomplete="off">
                              </div>
                              <div class="mb-3">
                                <label for="sks_matakuliah" class="form-label">SKS</label>
                                <input type="number" class="form-control" id="sks_matakuliah" name="sks_matakuliah" value="<?= $row["sks_matakuliah"] ?>" autocomplete="off">
                              </div>
                              <div class="mb-3">
                                <label for="id_dosen" class="form-label">Dosen Pengampu</label>
                                <select name="id_dosen" class=" form-select" aria-label="Default select example">
                    ...
                    <!-- Edit Modal End -->
                    <button class="btn btn-danger"><a class="text-decoration-none text-white" href="matakuliah-fungsi-hapus.php?id=<?= $row["id_matakuliah"] ?>" onclick="
