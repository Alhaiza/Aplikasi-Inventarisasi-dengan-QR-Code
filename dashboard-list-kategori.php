...
<body>
  ...
  <div class="main-container">
    ...
    <main class="content vh-100 bg-body-tertiary p-5 mt-5">
      <h1 class="fs-6">Halaman Daftar Kategori</h1>
            ...
            <tbody>
              ...
              <?php foreach ($kategori as $row) : ?>
                <tr class="text-center">
                  ...
                  <td class="py-3">
                    <!-- Button Edit modal -->
                    <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#edit<?= $row["id_kategori"] ?>">
                      Ubah
                    </button>

                    <!-- Edit Modal -->
                    <div class="modal fade" id="edit<?= $row["id_kategori"] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                          ...
                          <div class="modal-body text-start">
                            <form method="post">
                              <input type="hidden" class="form-control" id="id_kategori" name="id_kategori" value="<?= $row["id_kategori"] ?>" autocomplete="off">
                              <div class="mb-3">
                                <label for="nip" class="form-label">Nama Kategori</label>
                                <input type="text" class="form-control" id="nama_kategori" name="nama_kategori" value="<?= $row["nama_kategori"] ?>" autocomplete="off">
                              </div>
                              <div class="modal-footer">
                    ...
                    <!-- Add Modal End -->
                    <button class="btn btn-danger"><a class="text-decoration-none text-white" href="kategori-fungsi-hapus.php?id=<?= $row["id_kategori"] ?>" onclick="
